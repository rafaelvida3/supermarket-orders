    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6">
      <div>
        ...
        <InputText
          ...
          maxlength="120"
        />
        <Message v-if="submitted && !customerName" severity="error" size="small" variant="simple">
      ...
      <div>
        ...
        <DatePicker
          ...
          :disabled="isViewMode"
        />
        <Message v-if="submitted && !deliveryDate" severity="error" size="small" variant="simple">
...
const goToStock = async () => {
  await router.push({ name: "stock.index" });
};

const goToOrdersList = async () => {
